		...
		tpl		= {
			...
			body	: function (elements, container_class_name) {
				...
				for (var i = 0; i < elements.length; ++i) {
					result	+= '<div class="' + elements[i].class_name + ' pmu-button"><span class="-item-to-round">' + elements[i].text + '</span></div>'
				}
...
$(function () {
	$('.single').pickmeup({
		flat	: true,
		change	: function (){location.href = 'http://val.ua/uk/site/news/date/'+$(this).pickmeup('get_date', "Y-m-d")+'.html';}
	});
	// $('input.single-date').pickmeup({
	// 	position		: 'bottom',
	// 	hide_on_select	: true
	// });
